...
import phase3 from '@/assets/Screenshot 2025-09-07 135248.png';
import phase4 from '@/assets/Screenshot 2025-09-07 135838.png';
import phase5 from '@/assets/Screenshot 2025-09-07 142157.png';
import phase6 from '@/assets/Screenshot 2025-09-07 143144.png';
import phase7 from '@/assets/Screenshot 2025-09-07 143719.png';
import phase8 from '@/assets/Screenshot 2025-09-07 144649.png';
import phase9 from '@/assets/Screenshot 2025-09-07 145133.png';
import phase10 from '@/assets/Screenshot 2025-09-07 155657.png';
 ...
 const milestones = [
  {
    ...
    image: phase1,
    projectLink: "https://dibimbing-lms-dev.s3.ap-southeast-1.amazonaws.com/1748671495027-Day-4-OKR.pdf"
  },
  {
    ...
    skills: ["Market Research", "Segmentation & Targeting", "Positioning Strategy", "Competitive Analysis", "Audience Analysis"],
    image: phase2,
    projectLink: "https://dibimbing-lms-dev.s3.ap-southeast-1.amazonaws.com/1748696392506-Day-5-Exercise-Knowing-Your-Market.pdf"
  },
  {
    ...
    skills: ["Product Strategy", "Customer Needs Analysis", "Value Proposition Design", "Business Model Canvas", "Market Segmentation", "Go-to-Market Strategy"],
    image: phase3,
    projectLink: "https://dibimbing-lms-dev.s3.ap-southeast-1.amazonaws.com/1749909533115-Nabila-Mutiara-Susetio_Vidiocom.pdf"
  },
  {
    ...
    skills: ["Qualitative Research", "User Interview Design", "Research Methodology", "User Behavior Analysis", "Insight Synthesis", "User-Centric Design"],
    image: phase4,
  ...
  },
  {
    ...
    skills: ["Research Synthesis", "Problem Framing (SCQA)", "Root Cause Analysis (5 Whys)", "UX Analysis", "Feature Optimization", "User Onboarding Strategies"],
    image: phase5,
    projectLink: "https://miro.com/app/board/uXjVIt-_waw=/?share_link_id=166462636890"
  },
  {
    phase: "Shoope Indonesia Ideation with Crazy 8 Method",
    ...
    skills: ["Ideation Techniques", "Crazy 8 Method", "How Might We (HMW)", "Feature Enhancement", "Gamification Design", "User Engagement Strategies"],
    image: phase6,
    projectLink: "https://dibimbing-lms-dev.s3.ap-southeast-1.amazonaws.com/1750483836597-Kelompok-4-Crazy-8s.pdf"
  },
  {
    ...
    skills: ["Mixed Methods Research", "Quantitative Analysis", "Qualitative Analysis", "Data Synthesis", "Affinity Mapping", "Subscription Model Optimization"],
    image: phase7,
    projectLink: "https://dibimbing-lms-dev.s3.ap-southeast-1.amazonaws.com/1751791682611-Vidiocom-Meningkatkan-Durasi-Menonton.pdf"
  },
  {
    ...
    skills: ["Business Requirements Documentation", "Stakeholder Alignment", "Requirement Gathering", "Solution Design", "User Behavior Analysis", "Data-Driven Decision Making"],
    image: phase8,
    projectLink: "https://dibimbing-lms-dev.s3.ap-southeast-1.amazonaws.com/1751791682611-Vidiocom-Meningkatkan-Durasi-Menonton.pdf"
  },
  {
    ...
    skills: ["Product Requirements Documentation", "Health Tech Solutions", "Gamification Design", "Stakeholder Management", "Public Health Strategy", "Feature Prioritization"],
    image: phase9,
  ...
  },
  {
    ...
    skills: ["Usability Testing", "Prototype Evaluation", "User Feedback Analysis", "UX Research", "Test Methodology Design", "Interaction Analysis"],
    image: phase10,
    projectLink: "https://docs.google.com/document/d/13kKvtO25dQLpqeKL8UZMeH2-YbQw9EMf/edit?usp=sharing&ouid=100302282808460211417&rtpof=true&sd=true"
  },
  {
    ...
    skills: ["Conversion Rate Optimization", "Funnel Analysis", "Technical Requirement Specification", "Checkout Process Optimization", "A/B Testing Design", "E-commerce Analytics"],
    image: phase11,
  ...
  },
  {
    ...
    skills: ["Personalization Systems", "Notification Strategy", "User Story Mapping", "Wireframing", "Product Roadmapping", "Engagement Optimization"],
    image: phase12,
  ...
  },
  {
    ...
    skills: ["Data Analysis", "Data Warehousing", "ETL Processes", "Database Normalization", "Business Intelligence", "Data Visualization"],
    image: phase13,
  ...
  },
  {
    ...
    skills: ["Technical Documentation", "System Architecture", "Infrastructure Planning", "Cloud Solutions Design", "Risk Assessment", "Resource Planning"],
    image: phase14,
